...
axis('image');
view([-135 35]);
title('STL as is loaded into MATLAB, including vectors and faces, prior to rotation to Standing Orientation')
xlabel('X Coordinate (mm)')
ylabel('Y Coordinate (mm)')
zlabel('Z Coordinate (mm)')

% Move points from structure arrays into table of X, Y, Z coordinates
c = struct2cell(fv);
vertices = c(2);
numVert = cell2mat(vertices);
X=numVert(:,1);
Y=numVert(:,3);
Z=numVert(:,2);
 n=length(X);
...
% figure
% plot3(square1face1x,square1face1y,square1face1z,'b.',square1face2x,square1face2y,square1face2z,'g.',square1face3x,square1face3y,square1face3z,'y.',square1face4x,square1face4y,square1face4z,'r.')
% daspect([1 1 1])
...
% figure
% plot3(square2face1x,square2face1y,square2face1z,'b.',square2face2x,square2face2y,square2face2z,'g.',square2face3x,square2face3y,square2face3z,'y.',square2face4x,square2face4y,square2face4z,'r.')
% daspect([1 1 1])
...
% figure
% plot3(square3face1x,square3face1y,square3face1z,'b.',square3face2x,square3face2y,square3face2z,'g.',square3face3x,square3face3y,square3face3z,'y.',square3face4x,square3face4y,square3face4z,'r.')
% daspect([1 1 1])
...
% plot3(square3face3x,square3face3y,square3face3z,'b.')
% daspect([1 1 1])

x=square3face3x.';
y=square3face3y.';
z=square3face3z.';
% sf=fit([y,z],x,'cubicinterp');
% plot(sf)
% daspect([1 1 1])
% figure
% plot3(square4face1x,square4face1y,square4face1z,'b.',square4face2x,square4face2y,square4face2z,'g.',square4face3x,square4face3y,square4face3z,'y.',square4face4x,square4face4y,square4face4z,'r.')
% daspect([1 1 1])
% 
...
writetable(T_dimensional,'MFCRawAutoCleanSTLWidthLength')
